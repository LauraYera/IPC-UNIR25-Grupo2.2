...
# Para evaluar la precisión del modelo calcularemos la matriz de confusión:
...
# Obtenemos probabilidades de las clases (como de probable es que un paciente se 
# clasifique en la clase AGH, CFB, CGC, CHC y HPB), para generar PR curves.
...
de over-fitting, por lo que compararemos con otros modelos.
