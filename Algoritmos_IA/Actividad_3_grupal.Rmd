...
También estarían las redes de grafos, que podríamos usar si tuvieramos, por ejemplo, grafos
...
Por lo tanto, la arquitectura más adecuada en nuestro caso (teniendo una tabla típica de expresión
de genes por muestra) seria la red de perceptrones, que podría aprender a partir de los valores
de expresión y predecir clasificaciones (como los tipos de tumor en nuestro caso).
