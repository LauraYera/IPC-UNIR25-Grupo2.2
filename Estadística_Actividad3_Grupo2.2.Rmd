...
```{r}
getwd()
path <- '/Users/laurayf/Desktop/UNIR/1Q/Estadística R para Ciencias de la Salud/Actividades/mubio02_act3'
setwd(path)
...
# no normale. Por lo tanto, usaremos mediana y rango intercuartílico para las estadísticas descriptivas.
...
# Ahora apilamos las tablas con una funcion de gtsummary y cambiamos el nombre
...
data_regression_factors$metastasis <- factor(data_regression_factors$metastasis, levels = c("no", "si"))
